			...
			<form method="post" action="logar.htm">
				...
				<div class="card-header bg-info">
					...
					<div class="card-body">
						...
						<input type="password" name="senha" required placeholder="digite aqui sua senha" title="senha aqui" class="form-control">
						<br><input type="submit" value="logar" name="btnLogar" class="btn btn-primary btn-block">
						<br><a href="/projeto01Web/senha.jsp" class="btn btn-link">esqueceu a senha</a>
						<br><a href="/projeto01Web/cadastrar.jsp" class="btn btn-link">cadastrar</a>
