...
insert into usuario values(4,'vandame@gmail.com','https://i.ytimg.com/vi/LjiKKkP77es/hqdefault.jpg','vandame','administrador',004,'m',126);

insert into endereco values(127,'estadio','12221160','Rj','Rj','Estadio 21');
insert into usuario values(5,'stalone@gmail.com','http://beta.ems.ladbiblegroup.com/s3/content/808x455/5ca2abf45a8d5db9619d2fabd8dde802.png','stalone','administrador',005,'m',127);


insert into endereco values(10,'Centro','324928187','mg','mg','Rua da vele 2');
insert into usuario values(6,'magneto@gmail.com','https://imgc.allpostersimages.com/img/print/posters/roger-cruz-magneto-no-1-cover-magneto-flying_a-G-13483435-4988577.jpg','magneto','usuario',006,'m',10);


insert into endereco values(11,'tempestade','12221160','Rj','Rj','Estadio 21');
insert into usuario values(7,'tempestade@gmail.com','https://www.ftsa.edu.br/home/images/tempestade.jpg','tempestade','usuario',007,'f',11);

insert into endereco values(12,'Muambator','234321600','RN','RN','RUA DA MIRI 2');
insert into usuario values(8,'ciclope@gmail.com','https://static3.tcdn.com.br/img/img_prod/460977/boneco_ciclope_cyclops_x_men_the_laser_eye_escala_1_6_toys_era_20293_2_20170516182451.jpg','ciclope','usuario',008,'m',12);

insert into endereco values(13,'vampira','00221160','Rj','Rj','Estadio 21');
insert into usuario values(9,'Vampira@gmail.com','http://3.bp.blogspot.com/-sFPY0bKQi0s/T2yru3fuPKI/AAAAAAAAFh8/DTDjLX9rrxQ/s640/vampira+maila+nurmi.jpg','vampira','usuario',009,'f',13);
